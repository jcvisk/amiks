...
if ( isset( $_POST ) ) {
    ...
    $pagada = isset( $_POST['pagadas'] ) ? mysqli_real_escape_string( $conexion, $_POST['pagadas'] ) : '' ;
    $vendida = isset( $_POST['vendidas'] ) ? mysqli_real_escape_string( $conexion, $_POST['vendidas'] ) : '' ;
    $cambio = isset( $_POST['cambios'] ) ? mysqli_real_escape_string( $conexion, $_POST['cambios'] ) : '' ;
    $consigna = isset( $_POST['consignas'] ) ? mysqli_real_escape_string( $conexion, $_POST['consignas'] ) : '' ;
    $consignaAnterior = isset( $_POST['consigna_anterior'] ) ? mysqli_real_escape_string( $conexion, $_POST['consigna_anterior'] ) : '' ;
